...
describe('TodoEffects', () => {
  ...
  describe('effects for clear completed todos', () => {
    ...
    it('should dispatch showNetworkError action on error in clearCompleted', () => {
      const error = 'Failed to clear completed todos. Please try again.';
      const action = TodoActions.CLEARCOMPLETED();
